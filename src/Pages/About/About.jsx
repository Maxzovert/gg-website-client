        ...
        <section className="mb-16 sm:mb-20">
          ...
          <div className="max-w-2xl mx-auto">
            <p className="about-body text-stone-600 text-base sm:text-lg leading-relaxed text-center">
              ...
              As a traditional spiritual brand now going online, Gawri Ganga (proudly operated by BNB Basket and Boxes Gifting Solutions Private Limited) aims to carry
